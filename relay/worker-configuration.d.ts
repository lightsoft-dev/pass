/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab1d9dd00b9a526c961fac26a922ade8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAY_AUTH_TOKEN">> {}
}
