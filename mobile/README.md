...
When OIDC is configured, an unauthenticated app opens the PKCE login flow. The iPhone or iPad then claims a
v2 pairing code generated by the signed-in Mac. The relay returns a 15-minute access credential
and rotating 30-day refresh credential bound to the account, desktop, mobile device, role, and scopes.
