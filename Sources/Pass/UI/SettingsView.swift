...
struct SettingsView: View {
    ...
    private var mobileAccessSection: some View {
        Section(appModel.remotePublicAccessAvailable ? "Mobile access" : "Mobile access · developer preview") {
            if appModel.remotePublicAccessAvailable {
                publicMobileAccessControls
            } else {
                developerMobileAccessControls
            }
        }
    }

    @ViewBuilder
    private var publicMobileAccessControls: some View {
    ...
    @ViewBuilder
    private var developerMobileAccessControls: some View {
